...
public enum PromptSafety {
  ...
  /// workspaces are untrusted until this boundary succeeds.
  ...
  private static func hasAllowedActionHead(_ source: String) -> Bool {
    ...
    return ["move", "container", "pickup", "drop", "backpack", "object", "inspect"]
...
public struct AgentBroadcastEvent: Equatable, Sendable {
